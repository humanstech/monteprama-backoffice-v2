/**
 *  This file is a mirror of the original type definitions for next-themes
 *  with type augmentations for the Theme type.
 */
...
interface ScriptProps
	extends React.DetailedHTMLProps<
		...
		HTMLScriptElement
	> {
	// biome-ignore lint/suspicious/noExplicitAny: this is a mirror of the original type
