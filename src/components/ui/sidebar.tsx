...
function SidebarProvider({
	...
	const setOpen = useCallback(
		(value: boolean | ((value: boolean) => boolean)) => {
			...
			// biome-ignore lint/suspicious/noDocumentCookie: shadcn sidebar component uses cookie for state persistence
...
function Sidebar({
	...
	return (
		...
		>
			...
			>
				<div
					className='flex h-full w-full flex-col rounded-r-2xl bg-sidebar group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow-sm'
					data-sidebar='sidebar'
