...
import {
	useApproveSummary,
	useCloneSummaryToTemporary,
	useGenerateSummaryAltText,
	useSummaries,
	useSummaryTts,
	useTranslateSummary,
...
function StepGeneratedTexts({
	...
	const generate = useGenerateSummaryAltText()
...
function StepTranslations({
	...
	const translate = useTranslateSummary()
...
function SummaryEditPage() {
	...
	const cloneToTemp = useCloneSummaryToTemporary()
	...
	const hasTemporary = Object.keys(summary.dataTemporary).length > 0
